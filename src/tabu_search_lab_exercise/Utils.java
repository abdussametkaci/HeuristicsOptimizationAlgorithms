...
public class Utils {
    ...
    // compare two list as exatly same by using name attribute (name identical)
    private static boolean isStrictlyEqual(List<City> solution1, List<City> solution2){
    ...
    // check that whether tabuList has the solution
